variable "region" {
  ...
  validation {
    condition     = contains(["us-south", "us-east", "che-01", "au-syd", "br-sao", "ca-tor", "eu-de", "eu-gb", "eu-es", "jp-osa", "jp-tok"], var.region)
    error_message = "Valid regions: us-south, us-east, che-01, au-syd, br-sao, ca-tor, eu-de, eu-gb, eu-es, jp-osa, jp-tok."
  }
}
